...
// ---------------------------------------------------------------------------
// Níveis de acesso (quanto MENOR o número, maior o poder)
//   1  = Super Administrador (admin global — enxerga tudo)
//   11 = Administrador
//   15 = ONG  (gerencia apenas os próprios animais)
//   21 = Usuário comum (adotante)
// validaNivelAcesso($min) libera quem tem nível <= $min.
// ---------------------------------------------------------------------------
defined("NIVEL_SUPER")   || define("NIVEL_SUPER",   1);
defined("NIVEL_ADMIN")   || define("NIVEL_ADMIN",   11);
defined("NIVEL_ONG")     || define("NIVEL_ONG",     15);
defined("NIVEL_USUARIO") || define("NIVEL_USUARIO", 21);
